...
# Do NOT export _RITE_CREATE_FOLLOWUP_ISSUES_LOADED — subprocesses must re-source.
if [ "${_RITE_CREATE_FOLLOWUP_ISSUES_LOADED:-}" = "true" ]; then
  return 0 2>/dev/null || true
fi
_RITE_CREATE_FOLLOWUP_ISSUES_LOADED=true
